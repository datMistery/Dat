...
public class FirebaseMethods {
    ...
    private void addPhotoToDatabase(String caption, String url){
        ...
        String newPhotoKey = mRootRef.child(mContext.getString(R.string.dbname_photos)).push().getKey();
        ...
        mRootRef.child(mContext.getString(R.string.dbname_user_photos))
                .child(FirebaseAuth.getInstance().getCurrentUser()
                        .getUid()).child(newPhotoKey).setValue(photo);
        mRootRef.child(mContext.getString(R.string.dbname_photos)).child(newPhotoKey).setValue(photo);
 ...
 /*   public boolean checkIfUsernameExists(String username, DataSnapshot datasnapshot){
    ...
    * */
    public void addNewUser(String email, String username, String description, String website, String profile_photo) {
        ...
        User user = new User(email, StringManipulation.condenseUsername(username), userID, 0);
