...
import com.home.instagram.Utils.Comment;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                    Log.d(TAG, "onDataChange: found user: " +
                            singleSnapshot.child(getActivity().getString(R.string.field_user_id)).getValue());

                    mFollowing.add(singleSnapshot.child(getActivity().getString(R.string.field_user_id)).getValue().toString());
                }
